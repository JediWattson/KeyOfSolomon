        ...
        messages: [
            {
                role: 'system',
                content:
                    "You are a business analyst, looking at the following sequence determine what's going on in this user session",
            },
            {
                role: 'user',
                content: seq,
...
export async function POST(req) {
    ...
    if (process.env.XAI_API_KEY) {
        ...
        stream = res.body;
    } else stream = fs.createReadStream('chat_complete.txt');
